"""FILECARVE core — Carve embedded files from a blob by magic-byte signatures."""
...
RULES = [
    ("FIL-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("FIL-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("FIL-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
