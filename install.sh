#!/usr/bin/env sh
# Universal installer for filecarve. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/filecarve.git"
echo "Installing filecarve ..."
